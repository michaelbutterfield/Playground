...
Given('I go to the google search page', function () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
...
Given('I am on the Google website', function () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
When('I search {string}', function (phrase) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, website.googlesearchpage.searchTextBox.inputText(phrase)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, website.googlesearchpage.searchButton.click()];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
...
Then('the input search results will be displayed', function () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                ...
                return [4 /*yield*/, website.googlesearchedpage.searchResult.AssertElementIsDisplayed()];
                case 1:
                    //await AssertionHelper.AssertThat(website.google.searchButton.getText(), assertion.containsString("Angular"), "Test");
                    //await assertion.assertThat(website.googlesearchedpage.searchTextBox.getAttribute("value"), assertion.equalTo("Angular"));
                    _a.sent();
